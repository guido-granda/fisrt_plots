...
for i in range(0,len(redshifts)):
 ...
 ################# histogram Vdisk############################3
        hist1, bin_edges1= np.histogram(vdisk_t, bin_edges)
        idx1=(hist1 >0)
 # over the volume
 ...
 # correct for dV 
	 ...
	 ################## hist vhalom ###############################
        hist2, bin_edges2= np.histogram(vhalo_t, bin_edges)
        idx2=(hist2 >0)
	 # over the volume
	...
	########################################
        ...
        axs2.set_xlim(1E1,3E3)
	 #top plot
	     
        p1_1 = axs1.plot(bin_centers[idx3],hist1[idx3], label='Vdisk', marker='.', linestyle='-', markersize=4, c='k')
        p1_2 = axs1.plot(bin_centers[idx3],hist2[idx3], label='Vhalo', marker='.', linestyle='-', markersize=4, c='r' )
